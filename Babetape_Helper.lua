...
function main()
	...
	while not isSampAvailable() do wait(100) end
		imgui.Process = false
	sampAddChatMessage("{42AAFF}[Babetape Helper] {ffffff}��������!", -1)	
	sampAddChatMessage("{42AAFF}[Babetape Helper] {ffffff}���������: {42AAFF}/bbth. {FFFFFF}�����: {42AAFF}Tape", -1)	
	  	...
	  	imgui.Text(u8"������� �������: /acl")
			...
			imgui.SetNextWindowPos(imgui.ImVec2((sw/2),sh/2), imgui.Cond.FirstUseEver, imgui.ImVec2(0.5,0.5))
			 ...
			 imgui.Text(u8"������")			 
				...
				imgui.SameLine()
				imgui.TextQuestion(u8"������ ������ ������ � ��������� ����� ����������� ������.")
				imgui.Checkbox(u8"C��� ������� � ��", zz)
				mainIni.config.zz = zz.v
				save()
				imgui.SameLine()
				imgui.TextQuestion(u8"��� ������ ������ ������ ������ � ������� '��������� ������' - �� ��� ���������.")
				imgui.Checkbox(u8"C��� ������� � �����", pizza)
				mainIni.config.pizza = pizza.v
				save()
				imgui.SameLine()
				imgui.TextQuestion(u8"��� ������ ������ ������ ������ � ������� '�� ������� �������� �����' - �� ��� ���������.")	
				if imgui.Checkbox(u8"���������� ��������� ������ ��������", blockweather) then
			...
			imgui.Text(u8"���������")
				...
				save()
				imgui.SameLine()
				imgui.TextQuestion(u8"��� ������� ��������� ������ CAN �� ��������� ��������� ��������� ��������.")
				imgui.Checkbox(u8"�������� ����", recar)
				mainIni.config.recar = recar.v
				save()
				imgui.SameLine()
				imgui.TextQuestion(u8"��� ������� �������� ������ RECAR �� �������� ��������� ��������� �����������.")
...
function hook.onServerMessage(color, message)
	if acd.v then
		if message:find("�����������! ������ ���� ��������� ����������� ���!") and not message:find('�������') and not message:find('- |') then
			sampSendChat('/lock')
		end
	end
end
			...
			if f then
			  ...
			  if updateversion ~= thisScript().version then
				lua_thread.create(function(prefix)
				  local dlstatus = require('moonloader').download_status
				  local color = -1
				  sampAddChatMessage(('{42AAFF}[Babetape Helper] {FFFFFF}���������� ����������. ������� ���������� c {42AAFF}'..thisScript().version..' {FFFFFF}�� {42AAFF}'..updateversion), color)	
				  wait(250)
				  downloadUrlToFile(updatelink, thisScript().path,
					function(id3, status1, p13, p23)
					  ...
					  elseif status1 == dlstatus.STATUS_ENDDOWNLOADDATA then
						print('�������� ���������� ���������.')
						sampAddChatMessage(('{42AAFF}[Babetape Helper] {FFFFFF}���������� ���������!'), color)
						goupdatestatus = true
